    ...
    <div class="login-box">
        ...
        <div class="card card-outline">
            <div class="card-header text-center d-flex justify-content-center align-items-center">
                <img src="{{url('dist/img/polinema.png')}}" alt="SIMAS Logo" class="brand-image img-circle elevation-3" style="width: 40px; height: 40px;">
                <a href="/" class="h1 ml-2"><b>SIMA</b></a>
            </div>
            <div class="card-body">
